...
export type Article = {
  ...
  song?: Maybe<Song>;
  articlesRelation: ArticleConnection;
};


export type ArticleArticlesRelationArgs = {
...
export type ArticleQuery = (
  ...
  & { article?: Maybe<(
    { __typename?: 'Article' }
    & Pick<Article, 'id' | 'title' | 'image_path' | 'description' | 'body' | 'published_time'>
    & { song?: Maybe<(
      { __typename?: 'Song' }
      & Pick<Song, 'id'>
      & { genres: Array<(
      ...
      & { pageInfo: (
        ...
        & { node: (
          { __typename?: 'Article' }
          & Pick<Article, 'id' | 'title' | 'slug' | 'image_path' | 'description' | 'body' | 'published_time'>
        ) }
      )> }
    ) }
  )> }
  ...
  & { featuredList?: Maybe<(
    ...
    & { pageInfo: (
      ...
      & { node: (
        ...
        & { item?: Maybe<{ __typename?: 'Chart' } | { __typename?: 'ContentProvider' } | { __typename?: 'ContentProviderDetail' } | (
          { __typename?: 'Genre' }
          & Pick<Genre, 'slug'>
        ) | { __typename?: 'Member' } | { __typename?: 'PublicUser' } | { __typename?: 'RbtPackage' } | { __typename?: 'RingBackTone' } | (
          { __typename?: 'Singer' }
          & Pick<Singer, 'slug'>
        ) | (
          { __typename?: 'Song' }
...
export type NodeQuery = (
  { __typename?: 'Query' }
  & { node?: Maybe<{ __typename?: 'Chart' } | { __typename?: 'ContentProvider' } | { __typename?: 'ContentProviderDetail' } | { __typename?: 'Genre' } | { __typename?: 'Member' } | { __typename?: 'PublicUser' } | { __typename?: 'RbtPackage' } | { __typename?: 'RingBackTone' } | { __typename?: 'Singer' } | (
    { __typename?: 'Song' }
    & { tones: Array<(
      { __typename?: 'RingBackTone' }
      & Pick<RingBackTone, 'duration' | 'fileUrl'>
...
export type SpamBaseFragment = (
  ...
  & { item?: Maybe<{ __typename: 'Chart' } | { __typename: 'ContentProvider' } | { __typename: 'ContentProviderDetail' } | { __typename: 'Genre' } | { __typename: 'Member' } | { __typename: 'PublicUser' } | { __typename: 'RbtPackage' } | (
    { __typename: 'RingBackTone' }
    & Pick<RingBackTone, 'id'>
    & { song?: Maybe<(
      { __typename?: 'Song' }
...
export type ToneBaseFragment = (
  { __typename?: 'RingBackTone' }
  & Pick<RingBackTone, 'name' | 'singerName' | 'price' | 'toneCode' | 'orderTimes' | 'availableAt'>
  & { contentProvider?: Maybe<(
    { __typename?: 'ContentProvider' }
