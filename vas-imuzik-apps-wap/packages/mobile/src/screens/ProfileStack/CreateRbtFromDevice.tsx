...
import { AnimatedEq, HeaderClose, Icon, IconName, ICON_GRADIENT_1, InputWithButton, usePlayer } from '../../components';
            ...
            >
              ...
              <Flex flex={1} alignItems="center" flexDirection="row">
                <Flex
                  ...
                  alignItems="center"
                  mr={3}>
                  <Image source={require('../../../assets/logo-music.png')} style={{ width: 40, height: 40 }} />
                </Flex>
                <Flex flex={4}>
                  <Text
                    fontSize={14}
