...
class Login6ViewController: BaseViewController {
    ...
    func setupView() {
        self.navigationItem.title = String.quen_mat_khau
...
extension Login6ViewController: UITextFieldDelegate {
