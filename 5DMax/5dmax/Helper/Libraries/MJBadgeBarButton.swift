...
class MJBadgeBarButton: UIBarButtonItem {
    ...
    func setup(customButton: UIButton) {
        ...
        self.badgeBGColor = UIColor.colorFromHexa("32b7bb")
        ...
        self.badge = UILabel(frame: CGRect(x: self.badgeOriginX,
                                           y: self.badgeOriginY,
    ...
    func updateBadgeFrame() {
        ...
        self.badge.frame = CGRect(x: self.badgeOriginX,
                                  y: self.badgeOriginY,
    ...
    func addRemoveBadge(_ remove: Bool) {
        UIView.animate(withDuration: 0.3) { 
            self.badge.isHidden = remove
        }
    }
}
