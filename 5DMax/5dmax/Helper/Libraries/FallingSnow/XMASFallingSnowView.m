...
#define kDefaultFlakesCount 66
#define kDefaultFlakeWidth 20.0 * 3 / 4
#define kDefaultFlakeHeight 23.0 * 3 / 4
#define kDefaultFlakeFileName @"XMASSnowflake.png"
#define kDefaultMinimumSize 0.4
#define kDefaultAnimationDurationMin 3.0
#define kDefaultAnimationDurationMax 6.0
...
- (id)initWithFrame:(CGRect)frame flakesCount:(int) flakesCount animationDurationMin:(float) animationDurationMin animationDurationMax:(float) animationDurationMax {
    if ((self = [super initWithFrame:frame])) {
        ...
        // Set default values
        self.flakesCount          = flakesCount;
        self.flakeWidth           = kDefaultFlakeWidth;
        self.flakeHeight          = kDefaultFlakeHeight;
        self.flakeFileName        = kDefaultFlakeFileName;
        self.flakeMinimumSize     = kDefaultMinimumSize;
        self.animationDurationMin = animationDurationMin;
        self.animationDurationMax = animationDurationMax;
    }
    return self;
}
