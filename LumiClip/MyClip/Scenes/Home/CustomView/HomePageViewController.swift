...
class HomePageViewController: BaseHomeSimpleTableViewController<ContentModel>{
    let service = VideoServices()
    override func viewDidLoad() {
        super.viewDidLoad()
        // Do any additional setup after loading the view.
        logScreen(GoogleAnalyticKeys.recommend.rawValue)
        LoggingRecommend.viewRecommendPage()
    }
    ...
    override func getData(pager: Pager,
                          _ completion: @escaping (Result<APIResponse<[ContentModel]>>) -> Void) {
