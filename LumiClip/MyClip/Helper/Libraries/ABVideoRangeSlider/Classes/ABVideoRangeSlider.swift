...
public class ABVideoRangeSlider: UIView, UIGestureRecognizerDelegate {
    ...
    public var progressTimeView        = ABTimeView()
    ...
    let indicatorWidth: CGFloat = 13.0
    ...
    private func setup(){
        ...
        progressTimeView = ABTimeView(size: CGSize(width: 60, height: 30), position: 1)
        progressTimeView.layer.anchorPoint = CGPoint(x: 0.5, y: 0.5)
    ...
    public func updateProgressIndicator(position: CGFloat){
...
//            }
    ...
    override public func layoutSubviews() {
        ...
        progressTimeView.timeLabel.text = self.secondsToFormattedString(totalSeconds: secondsFromValue(value: self.progressPercentage))
        ...
        progressTimeView.center = CGPoint(x: progressIndicator.center.x, y: startTimeView.center.y)
    }
