...
-(id)init
{
    ...
    if(self)
    {
        ...
        self.rotatable = YES;
        self.autoplay = YES;
        self.topPlayerHeight = ceil(screenWidth / 16 * 9 );
        self.miniPlayerHeight = 70;
        self.miniPlayerWidth = miniPlayerHeight * 16 / 9;
        UITabBarController *tabBarController = [UITabBarController new];
        CGFloat tabBarHeight = tabBarController.tabBar.frame.size.height;
        self.maxVerticalMovingHeight = screenHeight - tabBarHeight;
