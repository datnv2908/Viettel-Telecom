//
//  BaseFollowSimpleTableViewController.swift
//  MyClip
//
//  Created by Manh Hoang Xuan on 5/4/18.
...
class BaseFollowSimpleTableViewController<T: NSObject>: BaseViewController, UITableViewDataSource, UITableViewDelegate, VideoTableViewCellDelegate, VideoSmallTableViewCellDelegate, UIScrollViewDelegate {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        trace = Performance.startTrace(name:"Theodoi")
